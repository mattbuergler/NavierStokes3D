...
@views function runme(; do_vis=true, do_save=false)
    ...
    if do_vis
        ...
        png(p1,@sprintf("viz3D_out/3D_NavierStokes_Pr_%04d.png",iframe))
        png(p3,@sprintf("viz3D_out/3D_NavierStokes_C_%04d.png",iframe))
        png(p4,@sprintf("viz3D_out/3D_NavierStokes_Vx_%04d.png",iframe))
        png(p5,@sprintf("viz3D_out/3D_NavierStokes_Vy_%04d.png",iframe))
        png(p6,@sprintf("viz3D_out/3D_NavierStokes_Vz_%04d.png",iframe))
        ...
        png(p1,@sprintf("viz3D_out/3D_NavierStokes_long_Pr_%04d.png",iframe))
        png(p3,@sprintf("viz3D_out/3D_NavierStokes_long_C_%04d.png",iframe))
        png(p4,@sprintf("viz3D_out/3D_NavierStokes_long_Vx_%04d.png",iframe))
        png(p5,@sprintf("viz3D_out/3D_NavierStokes_long_Vy_%04d.png",iframe))
        png(p6,@sprintf("viz3D_out/3D_NavierStokes_long_Vz_%04d.png",iframe))
        iframe+=1
    end
    # action
    for it = 1:nt
        ...
        if do_vis && it % nvis == 0
            ...
            p6=heatmap(xc,yc,Array(Vz)[:,:,ceil(Int,nz/2)]';aspect_ratio=1,xlabel="x [m]",ylabel="y [m]",xlims=(-lx/2,lx/2),ylims=(-ly/2,ly/2),title="Vz")
            png(p1,@sprintf("viz3D_out/3D_NavierStokes_Pr_%04d.png",iframe))
            png(p2,@sprintf("viz3D_out/3D_NavierStokes_iter_%04d.png",iframe))
            png(p3,@sprintf("viz3D_out/3D_NavierStokes_C_%04d.png",iframe))
            png(p4,@sprintf("viz3D_out/3D_NavierStokes_Vx_%04d.png",iframe))
            png(p5,@sprintf("viz3D_out/3D_NavierStokes_Vy_%04d.png",iframe))
            png(p6,@sprintf("viz3D_out/3D_NavierStokes_Vz_%04d.png",iframe))
